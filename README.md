...
- **Backend**: Java 17+, Spring Boot, Spring WebFlux (Reactive), JPA / Hibernate, JWT & Spring Security, JUnit 5, Mockito.
- **Frontend**: Angular (Signals, Zoneless), React, TypeScript, Component-driven Architecture.
- **Architecture & Practices**: Hexagonal/Clean Architecture, Domain-Driven Design (DDD), Test-Driven Development (TDD), CI/CD, Agile methodologies.

---

## 📌 Featured Projects

Here is a curated selection of public repositories highlighting my work in backend engineering, modern web frontends, and architectural scaffolds:

### ⚡ Real-Time & Reactive Telemetry System (Full-Stack)
A complete full-stack environment showcasing real-time data streaming and reactive programming.
*   **Frontend**: [futuristic-hud-frontend](https://github.com/angelamonsalvep/futuristic-hud-frontend) — A tactical real-time dashboard built using **Angular 20 Zoneless** with **Signals** for reactive state management and automatic connection recovery.
*   **Backend**: [reactive-hud-stream](https://github.com/angelamonsalvep/reactive-hud-stream) — A reactive microservice built with **Java Spring WebFlux** that streams telemetry data using Server-Sent Events (SSE).

### 🛠️ Reactive Microservices Stack
Enterprise-grade reactive backend patterns built with Spring Boot.
...
*   **Storefront**: [tienda_frontend_react](https://github.com/angelamonsalvep/tienda_frontend_react) — An interactive, responsive web application built using **React** and modern state management.
...
- 💼 **LinkedIn**: [angela-monsalve-develop](https://www.linkedin.com/in/angela-monsalve-develop/)
- 📧 **Email**: [angelapmonsalve@gmail.com](mailto:angelapmonsalve@gmail.com)
